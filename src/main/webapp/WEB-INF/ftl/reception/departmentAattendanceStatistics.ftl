	...
	<head>
		...
		<script type="text/javascript">
			...
			$(function() {
				...
				var schoolName;
				var departmentId;
				<#if departmentCountList??>
					<#list departmentCountList as map>
						categories.push("${map.departmentName}");
						zhengChang.push(${map.qianDaoChiShu});
		...
		<script type="text/javascript">
			function getCount() {
				...
				if (startDate == '' || endDate == '') {
					...
					window.location.href = "departmentAattendanceStatistics?startTime=" + startDate + "&endTime=" + endDate;
				}
			}
				...
				<div class="box col-md-12">
					<div class="box-inner">
						<div class="box-header well" data-original-title="">
							<h2><i class="glyphicon glyphicon-edit"></i><b id="diName"></b>院系上课到勤统计</h2>
						</div>
						<div class="box-content">
							...
							<div class="controls">
								<table class="table table-striped table-bordered bootstrap-datatable datatable responsive" id="table2">
									...
									<thead>
										<tr>
											<th rowspan="2" style="vertical-align:middle; text-align:center;">院系</th>
