	...
	<head>
		...
		<script type="text/javascript">
			...
			$(function() {
						...
						series: {
							...
							events: {
								click: function(e) {
									...
									window.location.href = "findCourseTeacherPeriodOfTimeAttendance?courseName=" +e.point.category + "&startTime=" + startDate + "&endTime=" + endDate;
								}
							}
						}
					},
				...
				var endDate;
				<#if subjectCountList??>
					<#list subjectCountList as map>
						categories.push("${map.subjectName}");
		...
		<script type="text/javascript">
			function getCount() {
				...
				if (startDate == '' || endDate == '') {
					...
					window.location.href = "findCoursePeriodOfTimeAttendance?startTime=" + startDate + "&endTime=" + endDate;
				}
			}
				...
				<div class="box col-md-12">
					<div class="box-inner">
						<div class="box-header well" data-original-title="">
							<h2><i class="glyphicon glyphicon-edit"></i><b id="diName"></b>课程上课考勤统计</h2>
						</div>
						<div class="box-content">
							...
							<div class="controls">
								<table class="table table-striped table-bordered bootstrap-datatable datatable responsive" id="table2">
									<caption>
										<h2>${schoolName!}课程考勤总汇表</h2></caption>
									<caption>
										<h5 id="h5"></h5></caption>
									<thead>
										<tr>
											<th rowspan="2" style="vertical-align:middle; text-align:center;">课程名称</th>
